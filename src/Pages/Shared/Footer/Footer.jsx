const Footer = () => {
  return (
    <div className="bg-[#27282C] text-white">
      <footer className="footer p-10  px-20 ">
        <div>
          <span className="footer-title">Services</span>
          <a className="link link-hover">Judo </a>
          <a className="link link-hover">Kickboxing</a>
          <a className="link link-hover">Brazilian Jiu-Jitsu </a>
          <a className="link link-hover"> Wrestling</a>
          <a className="link link-hover">Taekwondo</a>
